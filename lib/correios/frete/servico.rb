  ...
  module Frete
    class Servico
      ...
      AVAILABLE_SERVICES = {
        ...
        "04596" => { :type => :pac_com_contrato_3,          :name => "PAC",            :description => "PAC com contrato"                  },
        "03298" => { :type => :pac_com_contrato_4,          :name => "PAC",            :description => "PAC com contrato"                  },
        "41211" => { :type => :pac_com_contrato_5,          :name => "PAC",            :description => "PAC com contrato"                  },
        ...
        "04553" => { :type => :sedex_com_contrato_7,        :name => "SEDEX",          :description => "SEDEX com contrato"                },
        "03220" => { :type => :sedex_com_contrato_8,        :name => "SEDEX",          :description => "SEDEX com contrato"                },
